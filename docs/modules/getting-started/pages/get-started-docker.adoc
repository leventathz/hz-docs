...
[source,sql]
----
CREATE MAPPING "my-distributed-map" TYPE IMap OPTIONS ('keyFormat'='varchar','valueFormat'='varchar');

SINK INTO "my-distributed-map" VALUES
('1', 'John'),
('2', 'Mary'),
('3', 'Jane');
----
...
[source,sql]
----
SELECT * FROM "my-distributed-map";
----
+
```
+--------------------+--------------------+
